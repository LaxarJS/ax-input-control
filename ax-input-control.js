...
define( [
    ...
    * long as the input field is focussed. Additionally the input field receives the class `ax-error`.
    ...
    * ```js
    * <input ng-model="someDate" ax-input="date" ax-input-range="'2010-01-02, 2014-03-01'" ax-input-required="true" ax-datepicker>
    * ```
    *
